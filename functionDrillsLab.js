...
function faveColorFinder(color) {
    let x = ''
    if (color == 'red'){
        x = 'red is a great color'
    } else if (color == 'green'){
        x = 'green is a solid favorite color'
    } else if (color == 'black'){
        x = 'so trendy'
    } else{
        x = 'you need to evaluate your favorite color choice'
    }
    return x;
}
...
console.log(emailCheck('hello@hello'));
...
//CODE HERE
function chocFrog(money){
    let frogs = Math.round(money/3)
    return frogs;
}
...
//I coded it correctly the first time

////////////////// PROBLEM 15 ////////////////////
let sampleArray = [2,1,2,3,4,5,6,8,9]
/*
